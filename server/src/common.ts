import { Diagnostic, TextDocuments, DiagnosticSeverity, DidChangeConfigurationNotification, DocumentDiagnosticReportKind, InitializeParams, InitializeResult, SemanticTokensBuilder, TextDocumentSyncKind, WorkspaceFoldersChangeEvent, DidChangeConfigurationParams, TextDocumentPositionParams, CompletionItem, CompletionItemKind, DocumentDiagnosticParams, DocumentDiagnosticReport, TextDocumentChangeEvent, Hover, SemanticTokens, InsertTextFormat, CompletionParams } from "vscode-languageserver";
...
export async function start(connection, documents) {
