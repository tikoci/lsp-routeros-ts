import { Range, TextDocument, Position } from 'vscode-languageserver-textdocument'
  ...
  get regexToken(): string[] {
    ...
    return this.tokens.map((t, i, a) => {
      switch (true) {
        ...
        case t === 'dir': return '/'
        case t === 'path': return '/'
        case t === 'none' && a[i - 1] === 'dir': return '/'
        case t === 'none' && text[i] === ' ': return ' '
        case t === 'none' && text[i - 1] === ' ' && text[i] === ' ': return '+'
        case t === 'none': return '_'
        case t === 'syntax-meta': return text[i]
        case t === 'cmd': return 'C'
        case t === 'arg': return 'A'
        case t === 'variable-parameter': return 'a'
        case t === 'variable-local': return 'v'
        case t === 'variable-global': return 'V'
        case t === 'variable-undefined': return 'u'
        case t === 'varname-local': return 'n'
        case t === 'varname-global': return 'N'
        case t === 'varname': return 'M'
        case t === 'ambiguous': return '*'
        case t === 'syntax-val': return 's'
        case t === 'syntax-obsolete': return 'O'
        case t === 'syntax-old': return 'o'
        case t === 'syntax-noterm': return '`'
        case t === 'escaped': return '\\'
        case t === 'comment': return '#'
        case t === 'obj-inactive': return 'I'
        case t === 'error': return 'E'
        default: return '?'
      }
    })
  }
