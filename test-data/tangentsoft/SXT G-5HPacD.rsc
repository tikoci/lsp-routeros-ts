...
#
# model = SXT G-5HPacD
/interface wireless set [ find default-name=wlan1 ] band=5ghz-a/n/ac channel-width=20/40/80mhz-XXXX disabled=no frequency=auto installation=outdoor ssid=MikroTik
...
/ip dhcp-client add comment=defconf interface=wlan1
/ip dhcp-server add address-pool=default-dhcp interface=ether1 name=defconf
