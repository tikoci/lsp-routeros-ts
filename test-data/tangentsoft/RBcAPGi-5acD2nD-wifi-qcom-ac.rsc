...
/interface wifi set [ find default-name=wifi1 ] channel.band=2ghz-n .skip-dfs-channels=10min-cac .width=20/40mhz configuration.mode=ap .ssid=MikroTik-47785A disabled=no
/interface wifi set [ find default-name=wifi2 ] channel.band=5ghz-ac .skip-dfs-channels=10min-cac .width=20/40/80mhz configuration.mode=ap .ssid=MikroTik-47785A disabled=no
